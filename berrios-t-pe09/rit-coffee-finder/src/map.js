...
const addMarkersToMap = () => {
    ...
    for (const feature of geojson.features) {
        const el = addMarker(feature.geometry.coordinates, feature.properties.title, feature.properties.description, "marker");
...
const addMarker = (cords, title, desc, className) => {
